...
void handle_create(const std::vector<std::pair<std::string, std::string> >& register_map, const int64_t& resource_id, 
        const std::string& resource_name, const std::string& objectIdentifer, const std::string& beegfs_path, const std::string& object_name, 
...
void handle_batch_create(const std::vector<std::pair<std::string, std::string> >& register_map, const int64_t& resource_id,
        const std::string& resource_name, const std::vector<std::string>& objectIdentifer_list, const std::vector<std::string>& beegfs_path_list,
